namespace FlowMe.Model.Const
{
    public static class BpmnXmlConst
    {
        ...
        public const string ACTIVITI_EXTENSIONS_NAMESPACE = "http://activiti.org/bpmn";
        public const string ACTIVITI_EXTENSIONS_PREFIX = "activiti";
