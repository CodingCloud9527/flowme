...
namespace FlowMe.Persistence.Entity
{
    ...
    public class TaskHistory
    {
        ...
        [Required] [StringLength(255)] public string TaskDefId { get; set; }
        ...
        [Required] public TaskHistory Task { get; set; }

        [StringLength(5000)] public string Description { get; set; }

        [Required] [StringLength(255)] public string Owner { get; set; }
        ...
        [StringLength(255)] public string FormKey { get; set; }
    }
}